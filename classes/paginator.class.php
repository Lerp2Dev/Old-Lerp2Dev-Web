...
class Paginator {
	...
	public function __construct($total=0,$mid_range=7,$ipp=10,$ipp_array=array(10,25,50,100,"All")) {
		...
		$this->items_per_page = isset($ipp) ? $ipp : (isset($_GET["ipp"]) ? $_GET["ipp"] : $this->ipp_array[0]);
